<template>
    <div class="trainAdd_box">
        <div class="add_single">
            ...
            <Input v-model="projectInfo.title" placeholder="请输入项目标题"  :maxlength="20" />
        </div>
        <div class="add_single">
            <p class="single_left">详情宣言：</p>
            <Input v-model="projectInfo.details" placeholder="请输入详情宣言" :maxlength="20" />
        </div>
        <div class="add_single">
            <p class="single_left">项目详情：</p>
            <Input type="textarea" v-model="projectInfo.project" placeholder="请输入项目详情" :maxlength="800" />
        </div>
        <div class="add_single">
        ...
        <div class="add_single">
            ...
            <Input v-model="projectInfo.price" placeholder="请输入项目价格"  />
        </div>
        <div class="add_single">
