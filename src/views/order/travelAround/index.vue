            ...
            <div class="content">
                ...
                <div class="content_bottom">
                    ...
                    <div class="single">
                        ...
                        <p class="single_right">{{detailInfo.location_start}}</p>
                    </div>
                    <div class="single">
                          <p class="single_left">成人:</p>
                        <p class="single_right">{{detailInfo.num}}人</p>
                    </div>
                    <div class="single">
                          <p class="single_left">儿童:</p>
                        <p class="single_right">{{detailInfo.num_children}}人</p>
                    </div>
                    <div class="single">
                          <p class="single_left">价格:</p>
                        <p class="single_right">{{detailInfo.priceStr}}元</p>
                    </div>
                </div>
                ...
                <div class="table_box">
                     <Table border="" :columns="priceColum" :data="priceData">
...
<script>
import travelAround from './travelAround'
export default travelAround
</script>
<style lang="less">
@import url("./travelAround.less");
</style>